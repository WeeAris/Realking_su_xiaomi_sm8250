...
static struct df_boost_drv df_boost_drv_g __read_mostly = {
	...
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_CPU0_CPU_LLCC_LAT,
		       CONFIG_DEVFREQ_MSM_CPU0_CPU_LLCC_LAT_BOOST_FREQ),
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_CPU4_CPU_LLCC_LAT,
		       CONFIG_DEVFREQ_MSM_CPU4_CPU_LLCC_LAT_BOOST_FREQ),
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_CPU0_LLCC_DDR_LAT,
		       CONFIG_DEVFREQ_MSM_CPU0_LLCC_DDR_LAT_BOOST_FREQ),
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_CPU4_LLCC_DDR_LAT,
		       CONFIG_DEVFREQ_MSM_CPU4_LLCC_DDR_LAT_BOOST_FREQ)
};
